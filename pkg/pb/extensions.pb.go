...
const file_api_extensions_proto_rawDesc = "" +
	"\n" +
	"\x14api/extensions.proto\x12\topenmatch\"1\n" +
	"\x19DefaultEvaluationCriteria\x12\x14\n" +
	"\x05score\x18\x01 \x01(\x01R\x05scoreB.Z open-match.dev/open-match/pkg/pb\xaa\x02\tOpenMatchb\x06proto3"

var (
	file_api_extensions_proto_rawDescOnce sync.Once
	file_api_extensions_proto_rawDescData []byte
)

func file_api_extensions_proto_rawDescGZIP() []byte {
	file_api_extensions_proto_rawDescOnce.Do(func() {
		file_api_extensions_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_extensions_proto_rawDesc), len(file_api_extensions_proto_rawDesc)))
	})
	return file_api_extensions_proto_rawDescData
}

var file_api_extensions_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_api_extensions_proto_goTypes = []any{
...
func file_api_extensions_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_extensions_proto_rawDesc), len(file_api_extensions_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
