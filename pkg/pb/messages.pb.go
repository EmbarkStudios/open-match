...
type Backfill struct {
	...
	// Ticket Ids represents the ticket Ids associated with this backfill
	TicketIds     []string `protobuf:"bytes,7,rep,name=ticket_ids,json=ticketIds,proto3" json:"ticket_ids,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Backfill) GetTicketIds() []string {
	if x != nil {
		return x.TicketIds
	}
	return nil
...
const file_api_messages_proto_rawDesc = "" +
	...
	"\x0fExtensionsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12*\n" +
	"\x05value\x18\x02 \x01(\v2\x14.google.protobuf.AnyR\x05value:\x028\x01J\x04\b\x05\x10\x06J\x04\b\x06\x10\a\"\x9d\x04\n" +
	"\bBackfill\x12\x0e\n" +
	...
	"generation\x12\x1d\n" +
	"\n" +
	"ticket_ids\x18\a \x03(\tR\tticketIds\x1aS\n" +
	"\x0fExtensionsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12*\n" +
	"\x05value\x18\x02 \x01(\v2\x14.google.protobuf.AnyR\x05value:\x028\x01\x1aX\n" +
	"\x14PersistentFieldEntry\x12\x10\n" +
