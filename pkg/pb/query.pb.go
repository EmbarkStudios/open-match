...
type QueryExpiredTicketsRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *QueryExpiredTicketsRequest) Reset() {
	*x = QueryExpiredTicketsRequest{}
	mi := &file_api_query_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *QueryExpiredTicketsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryExpiredTicketsRequest) ProtoMessage() {}

func (x *QueryExpiredTicketsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_query_proto_msgTypes[6]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use QueryExpiredTicketsRequest.ProtoReflect.Descriptor instead.
func (*QueryExpiredTicketsRequest) Descriptor() ([]byte, []int) {
	return file_api_query_proto_rawDescGZIP(), []int{6}
}

func (x *QueryExpiredTicketsRequest) GetLimit() int32 {
	if x != nil {
		return x.Limit
	}
	return 0
...
type QueryExpiredTicketsResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Tickets that meet all the filtering criteria requested by the pool.
	Tickets       []*Ticket `protobuf:"bytes,1,rep,name=tickets,proto3" json:"tickets,omitempty"`
	unknownFields protoimpl.UnknownFields
...
func (x *QueryExpiredTicketsResponse) Reset() {
	*x = QueryExpiredTicketsResponse{}
	mi := &file_api_query_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *QueryExpiredTicketsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryExpiredTicketsResponse) ProtoMessage() {}

func (x *QueryExpiredTicketsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_api_query_proto_msgTypes[7]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use QueryExpiredTicketsResponse.ProtoReflect.Descriptor instead.
func (*QueryExpiredTicketsResponse) Descriptor() ([]byte, []int) {
	return file_api_query_proto_rawDescGZIP(), []int{7}
}

func (x *QueryExpiredTicketsResponse) GetTickets() []*Ticket {
	if x != nil {
		return x.Tickets
	}
	return nil
...
const file_api_query_proto_rawDesc = "" +
	...
	"\tbackfills\x18\x01 \x03(\v2\x13.openmatch.BackfillR\tbackfills\"2\n" +
	"\x1aQueryExpiredTicketsRequest\x12\x14\n" +
	"\x05limit\x18\x01 \x01(\x05R\x05limit\"J\n" +
	"\x1bQueryExpiredTicketsResponse\x12+\n" +
	"\atickets\x18\x01 \x03(\v2\x11.openmatch.TicketR\atickets2\xb0\x04\n" +
	"\fQueryService\x12|\n" +
	...
	"\x0eQueryBackfills\x12 .openmatch.QueryBackfillsRequest\x1a!.openmatch.QueryBackfillsResponse\"+\x82\xd3\xe4\x93\x02%:\x01*\" /v1/queryservice/backfills:query0\x01\x12\x93\x01\n" +
	"\x13QueryExpiredTickets\x12%.openmatch.QueryExpiredTicketsRequest\x1a&.openmatch.QueryExpiredTicketsResponse\"+\x82\xd3\xe4\x93\x02%:\x01*\" /v1/queryservice/tickets:expired0\x01B\x98\x03\x92A\xe6\x02\x12\xbf\x01\n" +
...
var file_api_query_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_api_query_proto_goTypes = []any{
	...
	(*QueryExpiredTicketsRequest)(nil),  // 6: openmatch.QueryExpiredTicketsRequest
	(*QueryExpiredTicketsResponse)(nil), // 7: openmatch.QueryExpiredTicketsResponse
	(*Pool)(nil),                        // 8: openmatch.Pool
	(*Ticket)(nil),                      // 9: openmatch.Ticket
	(*Backfill)(nil),                    // 10: openmatch.Backfill
}
var file_api_query_proto_depIdxs = []int32{
	8,  // 0: openmatch.QueryTicketsRequest.pool:type_name -> openmatch.Pool
	9,  // 1: openmatch.QueryTicketsResponse.tickets:type_name -> openmatch.Ticket
	8,  // 2: openmatch.QueryTicketIdsRequest.pool:type_name -> openmatch.Pool
	8,  // 3: openmatch.QueryBackfillsRequest.pool:type_name -> openmatch.Pool
	10, // 4: openmatch.QueryBackfillsResponse.backfills:type_name -> openmatch.Backfill
	9,  // 5: openmatch.QueryExpiredTicketsResponse.tickets:type_name -> openmatch.Ticket
	0,  // 6: openmatch.QueryService.QueryTickets:input_type -> openmatch.QueryTicketsRequest
	2,  // 7: openmatch.QueryService.QueryTicketIds:input_type -> openmatch.QueryTicketIdsRequest
	4,  // 8: openmatch.QueryService.QueryBackfills:input_type -> openmatch.QueryBackfillsRequest
	6,  // 9: openmatch.QueryService.QueryExpiredTickets:input_type -> openmatch.QueryExpiredTicketsRequest
	1,  // 10: openmatch.QueryService.QueryTickets:output_type -> openmatch.QueryTicketsResponse
	3,  // 11: openmatch.QueryService.QueryTicketIds:output_type -> openmatch.QueryTicketIdsResponse
	5,  // 12: openmatch.QueryService.QueryBackfills:output_type -> openmatch.QueryBackfillsResponse
	7,  // 13: openmatch.QueryService.QueryExpiredTickets:output_type -> openmatch.QueryExpiredTicketsResponse
