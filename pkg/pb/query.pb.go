...
type QueryTicketsRequest struct {
	...
	// The limit on the number of results streamed back
...
func (x *QueryTicketsRequest) GetLimit() int32 {
	if x != nil {
		return x.Limit
	}
	return 0
...
func (x *QueryTicketIdsRequest) GetLimit() int32 {
	if x != nil {
		return x.Limit
	}
	return 0
...
func (x *QueryBackfillsRequest) GetLimit() int32 {
	if x != nil {
		return x.Limit
	}
	return 0
...
const file_api_query_proto_rawDesc = "" +
	"\n" +
	"\x0fapi/query.proto\x12\topenmatch\x1a\x12api/messages.proto\x1a\x1cgoogle/api/annotations.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\"P\n" +
	"\x13QueryTicketsRequest\x12#\n" +
	"\x04pool\x18\x01 \x01(\v2\x0f.openmatch.PoolR\x04pool\x12\x14\n" +
	"\x05limit\x18\x02 \x01(\x05R\x05limit\"C\n" +
	"\x14QueryTicketsResponse\x12+\n" +
	"\atickets\x18\x01 \x03(\v2\x11.openmatch.TicketR\atickets\"R\n" +
